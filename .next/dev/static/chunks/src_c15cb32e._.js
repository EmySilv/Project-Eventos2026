...
function Home() {
    ...
    if ($[0] !== "30d679db8aeac8513b94ba5ac5a22271aa2e9c086e147affde6431bcff3e4825") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "30d679db8aeac8513b94ba5ac5a22271aa2e9c086e147affde6431bcff3e4825";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
        ...
        t1 = ({
            "Home[useEffect()]": ()=>{
                const load = async function load() {
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEvents"])();
                    setEventos(data);
                };
                load();
            }
...
//# sourceMappingURL=src_c15cb32e._.js.map