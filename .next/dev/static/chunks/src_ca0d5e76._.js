...
function Graficos() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6);
    if ($[0] !== "f85e627b88bea5204dbf737eef5a0beef8931cd502f88dc42e991c3a4dd2e035") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f85e627b88bea5204dbf737eef5a0beef8931cd502f88dc42e991c3a4dd2e035";
    }
    const { eventos, colunas } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$eventsContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEvents"])();
    if (!eventos.length) {
        let t0;
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
//# sourceMappingURL=src_ca0d5e76._.js.map