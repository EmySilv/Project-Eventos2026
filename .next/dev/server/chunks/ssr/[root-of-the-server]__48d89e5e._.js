...
function UploadExcel() {
    ...
    const handleSubmit = async ()=>{
        ...
        if (!file.name.endsWith(".xlsx") && !file.name.endsWith(".csv")) {
            setStatus("Erro: formato inválido (use .xlsx ou .csv)");
            return;
        }
        try {
            setStatus("Lendo arquivo...");
            // 🔎 VALIDAÇÃO 3 — leitura do arquivo
            ...
            // 🔎 VALIDAÇÃO 4 — existe aba?
            if (!sheetName) {
                setStatus("Erro: planilha sem abas");
                return;
            }
            ...
            // 🔎 VALIDAÇÃO 5 — tem dados?
            if (data.length === 0) {
                setStatus("Erro: planilha vazia");
                return;
            }
            setStatus(`Salvando ${data.length} registros no banco...`);
            // 🔎 VALIDAÇÃO 6 — salvando no Firebase
            for (const row of data){
                if (!row.nomeEvento || !row.data) {
                    console.warn("Linha ignorada:", row);
                    continue;
                }
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "eventos"), row);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48d89e5e._.js.map